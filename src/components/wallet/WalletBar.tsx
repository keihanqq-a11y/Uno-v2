  ...
  return (
    <>
      <div className="relative flex items-center">
        <div className="flex overflow-hidden rounded-xl border border-white/15 bg-[#111]">
          <button
            type="button"
          ...
          <button
            type="button"
            onClick={() => openWalletTab("Deposit")}
            className="grid h-9 w-9 place-items-center bg-[#ef4444] text-white transition hover:bg-[#f87171] sm:h-10 sm:w-10"
